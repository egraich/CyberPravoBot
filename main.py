...
6. Анализировать сообщение целиком. Если опасные элементы являются частью обсуждения, цитирования или шутки (мета-контекст), снижать оценку угрозы, но указывать на наличие опасных паттернов в маркерах.

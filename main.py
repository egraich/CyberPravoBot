...
class Messages:
    ...
    Система 'КиберЩит' готова к работе. Я — ваш автономный ИИ-эксперт по анализу угроз.
    
    🔍 **Что делать?**
    Пришлите или перешлите мне подозрительное сообщение, и я проведу глубокий аудит на предмет фишинга и социальной инженерии.

...
4. Протокол защиты
(3-5 советов во множественном числе, разделенные дефисами и новыми строками. Если риск < 10%: "Дополнительные меры кибербезопасности не требуются. Продолжайте общение в штатном режиме").

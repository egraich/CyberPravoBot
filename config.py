...
(Сформулировать от 2 до 5 факторов. КРИТИЧЕСКИ ВАЖНО: Вместо текста [Название] придумать и вставить краткое уникальное название для каждого конкретного фактора):
- [Название]: Описание через призму контекста (например, запрос кода из СМС).
- [Название]: Описание через призму контекста (например, отсутствие признаков манипуляции).

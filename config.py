...
6. Проверка: Обязательно проверять все ссылки на легитимность и безопасность для пользователя.Если в сообщении упоминаются подозрительные файлы с расширениями, проверть их на безопасность, повышая вероятность угрозы в случае выявления опасных расширений(Макросы, стилеры, скрипты вне контекста и тд).
